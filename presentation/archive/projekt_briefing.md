...
7. **`live_vs_historical_median.png`** *(zusätzlich, explorativ — nicht Teil des 10-Folien-Decks)* —
   prozentuale Abweichung des Open-Meteo-Live-Werts vom historischen EEA-Median 2025 je Stadt/Schadstoff;
   0%-Linie, Quellen klar gekennzeichnet, Rom PM2.5/PM10 ohne Referenz nicht dargestellt.
